...
class SubscriptionItem extends StatelessWidget {
  ...
  print('this is subscriptions data ----> ${subscriptionModelData.subCategory?.image}');
    return Container(
            ...
            children: [
              Padding(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10),
                  child: CustomImage(
                    image: "${AppConstants.baseUrl}/storage/app/public/category/${subscriptionModelData.subCategory?.image}",
                    height: 75, width: 75,
                  ),
                ),
              ),
