...
class RecentActivityCardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('this is image pathhhhhh ----> ${AppConstants.baseUrl}/storage/app/public/category/${dashboardRecentActivityModel.detail![0].service != null ? dashboardRecentActivityModel.detail![0].service!.thumbnail: ''}');
    // print('this is data path ----> ${dashboardRecentActivityModel.readableId}');
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ClipRRect(
            ...
            child: CustomImage(height: 60, width: 60, fit: BoxFit.cover,
              ...
              image: "${AppConstants.baseUrl}/storage/app/public/category/${dashboardRecentActivityModel.detail![0].service != null ? dashboardRecentActivityModel.detail![0].service!.thumbnail: ''}",
            )
          ),
