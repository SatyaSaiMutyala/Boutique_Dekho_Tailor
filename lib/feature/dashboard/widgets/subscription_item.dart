...
class SubscriptionCardItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print('this is dataaaaaaaa ------>${subscriptionModelData.subCategory!=null?subscriptionModelData.subCategory!.image : ''}');
    return Container(
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            ClipRRect(borderRadius: BorderRadius.circular(5),
              child: CustomImage(height: 70, width: 70,
                image: '${AppConstants.baseUrl}/storage/app/public/category/${subscriptionModelData.subCategory!=null?subscriptionModelData.subCategory!.image:""}',
                fit: BoxFit.cover,
              ),
            ),
