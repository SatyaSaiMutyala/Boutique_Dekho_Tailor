...
class RatingBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < 5; i++) {
      if (i < realNumber) {
        starList.add(Icon(Icons.star, color: Theme.of(context).colorScheme.tertiary, size: size));
        ...
        starList.add(SizedBox(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              Icon(Icons.star, color: Theme.of(context).colorScheme.tertiary, size: size),
              ClipRect(
