import 'package:demandium_provider/feature/auth/widgets/sign_up_appbar.dart';
import 'package:demandium_provider/feature/auth/widgets/sign_up_step4.dart';
import 'package:demandium_provider/feature/auth/widgets/sign_up_step5.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void validateStep4(SignUpController signUpController) async {
    ...
    if(signUpController.selectedBusinessPlan == null){
      showCustomSnackBar("choose_business_plan".tr);
    }
      ...
      showCustomSnackBar("no_subscription_plan_available_at_this_moment".tr);
    } else{
  ...
  void validateStep5(SignUpController signUpController) async {
    ...
    if(signUpController.selectedSubscriptionPaymentType == null){
      showCustomSnackBar("free_trail_hint_text".tr);
    }
  ...
  SignUpBody _getSignUpBody(SignUpController signUpController){
    String companyNumberWithCountryCode = signUpController
        .countryDialCode + VerifyPhoneHelper.getValidPhone("${signUpController
