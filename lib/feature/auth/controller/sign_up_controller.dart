...
import 'package:demandium_provider/feature/subscriptions/model/package_subscription_model.dart';
...
class SignUpController extends GetxController {
  ...
  Future<void> registration(SignUpBody signUpBody) async {
    ...
    if (response!.statusCode == 200 && response.body['response_code'] == "provider_store_200") {
      ...
      else if(Get.find<SplashController>().configModel.content?.emailVerification==1 || Get.find<SplashController>().configModel.content?.phoneVerification==1){
        Get.toNamed(RouteHelper.getSendOtpScreen("verification", showSignUpDialog: true));
