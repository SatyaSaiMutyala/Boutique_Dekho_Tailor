                   ...
                   return  CustomButton(width: 220, height: 40,
                     ...
                     onPressed: transactionType == TransactionType.none ? null : (){
                       if(transactionType == TransactionType.payable || transactionType == TransactionType.adjustAndPayable){
                         ...
                         if((Get.find<SplashController>().configModel.content?.minimumPayableAmount ?? 0 ) <= transactionAmount){
                           ...
                           showCustomSnackBar("${'minimum_payable_amount'.tr} ${PriceConverter.convertPrice(Get.find<SplashController>().configModel.content?.minimumPayableAmount ?? 0)}");
                         }
