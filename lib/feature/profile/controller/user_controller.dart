  ...
  Future<bool> getProviderInfo({reload = false}) async {
    ...
    if(_providerModel==null || reload){
      ...
      if (response.statusCode == 200) {
        ...
        countryDialCode = VerifyPhoneHelper.getValidCountryCode(_providerModel?.content?.providerInfo?.companyPhone ?? "" ) != "" ? VerifyPhoneHelper.getValidCountryCode(_providerModel?.content?.providerInfo?.companyPhone ?? "") : CountryCode.fromCountryCode(Get.find<SplashController>().configModel.content!.countryCode!).dialCode ?? "+880";
        companyPhoneController!.text = VerifyPhoneHelper.getValidPhone(_providerModel?.content?.providerInfo?.companyPhone ?? "") != "" ? VerifyPhoneHelper.getValidPhone(_providerModel?.content?.providerInfo?.companyPhone??"" ) : _providerModel?.content?.providerInfo?.companyPhone ?? "";
        ...
        personalNameController!.text = _providerModel?.content?.providerInfo?.contactPersonName??"";
        personalPhoneController!.text = VerifyPhoneHelper.getValidPhone(_providerModel?.content?.providerInfo?.contactPersonPhone ?? "") != "" ? VerifyPhoneHelper.getValidPhone(_providerModel?.content?.providerInfo?.contactPersonPhone??"" ) : _providerModel?.content?.providerInfo?.contactPersonPhone ?? "";
        personalEmailController!.text = _providerModel?.content?.providerInfo?.contactPersonEmail??"";
