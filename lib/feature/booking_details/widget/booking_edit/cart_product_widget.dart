...
class CartItemView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    print('this is the image url path ----->' + '${cart?.serviceThumbnail}');
    print('this is the image url ----->' + '${AppConstants.baseUrl}/storage/app/public/category/${cart?.serviceThumbnail}');
    return Container(
          ...
          child: SizedBox(
            ...
            child: Row( children: [
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                child: CustomImage(
                  image: '${AppConstants.baseUrl}/storage/app/public/category/${cart?.serviceThumbnail}',
