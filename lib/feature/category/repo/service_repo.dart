...
class ServiceRepo{
  ...
  Future<Response> getSubCategoryList(String id ,int offset) async {
    return await apiClient.getData("${AppConstants.serviceSubcategoryUrl}?limit=${Get.find<SplashController>().configModel.content?.paginationLimit}&offset=$offset&id=$id");
  }
