                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              physics: const ClampingScrollPhysics(),
                              itemBuilder: (context, index) {
                                String imageUrl = "${AppConstants.baseUrl}/storage/app/public/category/${allServiceController.serviceCategoryList[index].image}";
                                    ...
                                    child: Column(
                                      children: [
                                        CategoryItem(
                                          ...
                                          image: imageUrl,
                                          title: allServiceController.serviceCategoryList[index].name.toString(),
                                          selectedCategory: allServiceController
                                              .serviceCategoryList[allServiceController.selectedCategory].name
                                              .toString(),
                                        ),
                                        index == allServiceController.serviceCategoryList.length - 1
                                            ? Container(
                                                height: 20,
                                                decoration: BoxDecoration(
                                                  color: Theme.of(context).cardColor,
