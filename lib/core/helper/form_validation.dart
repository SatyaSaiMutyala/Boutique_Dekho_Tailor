import 'package:demandium_provider/core/helper/phone_verification_helper.dart';
...
class FormValidationHelper {
  ...
  String? isValidEmailOrPhone(String value) {
    ...
    if( GetUtils.isPhoneNumber(value)  && VerifyPhoneHelper.getValidPhone(value) !=""){
      return null;
    }else if(GetUtils.isPhoneNumber(value) && value.length > 10 && VerifyPhoneHelper.getValidPhone(value) == ""){
  ...
  String? isValidPhone(String value) =>
      VerifyPhoneHelper.getValidPhone(value) == "" ? "invalid_phone_number".tr : null;
